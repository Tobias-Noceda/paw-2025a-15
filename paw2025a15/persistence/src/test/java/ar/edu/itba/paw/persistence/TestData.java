...
public class TestData {
    ...
    public class PatientDetails{
        ...
        public static final PatientDetail newPatientDetail = new PatientDetail(1, LocalDate.parse("2000-01-01"), BloodTypeEnum.AB_POSITIVE, 1.75, 89.00, false, true, null, null, null, null, null, null);
        public static final PatientDetail newPatientDetailNotNullValues = new PatientDetail(1, LocalDate.parse("2000-01-01"), BloodTypeEnum.AB_POSITIVE, 1.75, 89.00, false, true, "a", "a", "a", "a", "a", "a");
