  ...
  <body>
    ...
    <div class="page-container">
      ...
      >
            ...
            <div class="profile-header"> 
              ...
              <div class="profile-info-block">
                ...
                <sec:authorize access="hasRole('ROLE_DOCTOR')">
                  <p class="role"><spring:message code="doctor.details.license.label"/> <c:out value="${user_data.licence}" escapeXml="true"/></p>
                  <p class="role"><spring:message code="doctor.details.specialty.label"/> <spring:message code="specialty.${user_data.specialty}"/></p>
                </sec:authorize>
              </div>
            </div>
        ...
        <div class="card">
          ...
          <div class="field-container" style="width: 250px;">
            <form:label path="insuranceId" class="field-label">
              <spring:message code="profile.insurance.label"/>
            </form:label>
            <div class="custom-select">
              <div class="select-box">
                <span class="select-text">
                  <c:choose>
                    <c:when test="${user_data.insurance != null}">
                      <c:out value="${user_data.insurance.name}" escapeXml="true"/>
                    </c:when>
                    <c:otherwise>
                      <spring:message code="profile.insurance.placeholder"/>
                    </c:otherwise>
                  </c:choose>
                </span>
              ...
              <ul class="options-list">
                <li class="option" data-value="${null}">
            ...
            <form:hidden id="selectedInsurance" path="insuranceId" value="${user_data.insurance != null ? user_data.insurance.id : null}"/>
          </div>

          <c:set var="startStyle">
            <c:choose>
              <c:when test="${user_data.insurance != null}">
                display: flex;
              </c:when>
          ...
          <div
            ...
            id="insuranceNumberContainer"
            style="${startStyle}"
          >
            <form:label path="insuranceNumber"><spring:message code="profile.insuranceNumber.label"/></form:label>
            <c:set var="placeholder">
              <spring:message code="profile.insuranceNumber.placeholder"/>
            </c:set>
            <form:input
              ...
              value="${user_data.insuranceNumber != null ? user_data.insuranceNumber : ''}"
            />
            <form:errors path="insuranceNumber" cssClass="error-box" element="div"/>
          </div>
        </div>
        ...
        <c:set var="updateSecondaryText">
          <ul><li><spring:message code="doctorProfile.cancelAppointments.info.first"/></li><li><spring:message code="doctorProfile.cancelAppointments.info.second"/></li></ul>
        </c:set>
    ...
    <script>
      ...
      document.querySelectorAll('.custom-select').forEach(select => {
        ...
        const insuranceNumberContainer = document.querySelector('#insuranceNumberContainer');
        ...
        options.forEach(option => {
          option.addEventListener('click', () => {
            ...
            if(label === "N/A") {
              insuranceNumberContainer.style.display = "none";
              textSpan.innerText = "<spring:message code='profile.insurance.placeholder'/>";
              hiddenInput.value = null;
            } else {
              insuranceNumberContainer.style.display = "flex";
