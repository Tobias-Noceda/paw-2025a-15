  ...
  <body>
    ...
    <form:form modelAttribute="registerMedicForm" action="${postPath}" method="post">
      ...
      <div  style="padding: 7px">
        <form:label cssClass="form-title" path="name">Nombre: </form:label>
        <form:input type="text" path="name"/>
        <form:errors path="name" cssClass="formError" element="p"/>
      </div>

      <div style="padding: 7px">
        <form:label cssClass="form-title" path="surname">Apellido: </form:label>
        <form:input type="text" path="surname" />
        <form:errors path="surname" cssClass="formError" element="p"/>
      </div>

      <div style="padding: 7px">
        <form:label cssClass="form-title" path="email">Correo electronico: </form:label>
      ...
      <div style="padding: 7px">
        <form:label cssClass="form-title" path="obrasSociales">Obras sociales:</form:label>
      </div>
      ...
      <div style="padding: 7px">
        <form:label cssClass="form-title" path="schedules.startTime">Horario de inicio:</form:label>
        <form:select path="schedules.startTime" itemLabel="label" itemValue="value" items="${hoursSelectItems}" />
        <form:label cssClass="form-title" path="schedules.endTime">Horario de fin:</form:label>
