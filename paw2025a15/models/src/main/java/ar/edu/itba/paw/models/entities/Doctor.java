...
public class Doctor extends User {
    ...
    @ManyToMany(mappedBy = "authDoctors", fetch = FetchType.LAZY)
    private List<Study> authStudies;
    ...
    public void setAuthStudies(List<Study> authStudies){
        this.authStudies = authStudies;
    }
}
