...
public class DoctorDTO {
    ...
    public static DoctorDTO fromDoctor(final UriInfo uriInfo, final Doctor doctor) {
        ...
        URI freeAppointments = uriInfo.getBaseUriBuilder().path(AppointmentController.class).queryParam("userId", String.valueOf(doctor.getId())).queryParam("status", AppointmentStatus.FREE).queryParam("date", LocalDate.now()).build();
