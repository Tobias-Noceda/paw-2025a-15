...
public class StudyServiceImplTest {
    ...
    public void testCreateWithStudyDate(){
        ...
        Study study = ss.create(STUDYTYPE, COMMENT, List.of(FILE_ID), PATIENT_ID, DOC_ID, STUDY_DATE);
    ...
    public void testCreateWithoutStudyDate(){
        ...
        Study study = ss.create(STUDYTYPE, COMMENT, List.of(FILE_ID), PATIENT_ID, DOC_ID, null);
    ...
    public void testCreateWithStudyDateUploaderNotADoctorButThemselves(){
        ...
        Study study = ss.create(STUDYTYPE, COMMENT, List.of(FILE_ID), PATIENT_ID, PATIENT_ID, STUDY_DATE);
    ...
    public void testCreateWithoutStudyDateUploaderNotADoctorButThemselves(){
        ...
        Study study = ss.create(STUDYTYPE, COMMENT, List.of(FILE_ID), PATIENT_ID, PATIENT_ID, null);
    ...
    public void testCreateWithStudyDateFailure(){
        ...
        Assert.assertThrows(RuntimeException.class, () -> 
            ss.create(STUDYTYPE, COMMENT, List.of(FILE_ID), PATIENT_ID, DOC_ID, STUDY_DATE)
        );
    }
    ...
    public void testCreateWithoutStudyDateFailure(){
        ...
        Assert.assertThrows(RuntimeException.class, () -> 
            ss.create(STUDYTYPE, COMMENT, List.of(FILE_ID), PATIENT_ID, DOC_ID, null)
        );
    }
    ...
    @Test
    public void testGetFilteredStudiesCountNonexistentPatient(){
        Mockito.when(ps.getPatientById(Mockito.eq(PATIENT_ID))).thenReturn(Optional.empty());

        Assert.assertThrows(NotFoundException.class, () -> 
            ss.getFilteredStudiesCount(PATIENT_ID, DOC_ID, STUDYTYPE)
        );
    }

    @Test
    public void testGetFilteredStudiesCountNonexistentDoctor(){
        Mockito.when(ps.getPatientById(Mockito.eq(PATIENT_ID))).thenReturn(Optional.of(PATIENT));
        Mockito.when(ds.getDoctorById(Mockito.eq(DOC_ID))).thenReturn(Optional.empty());
    ...
    @Test
    public void testGetFilteredStudiesPageNonexistentPatient(){
        Mockito.when(ps.getPatientById(Mockito.eq(PATIENT_ID))).thenReturn(Optional.empty());

        Assert.assertThrows(NotFoundException.class, () -> 
            ss.getFilteredStudiesPage(PATIENT_ID, DOC_ID, STUDYTYPE, false, 1, 100)
        );
    }

    @Test
    public void testGetFilteredStudiesPageNonexistentDoctor(){
        Mockito.when(ps.getPatientById(Mockito.eq(PATIENT_ID))).thenReturn(Optional.of(PATIENT));
        Mockito.when(ds.getDoctorById(Mockito.eq(DOC_ID))).thenReturn(Optional.empty());
